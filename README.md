...
* [`src/cljs/cljapp/`](src/cljs/cljapp/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/cljapp/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `cljapp` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/cljapp/config.cljs) defaults to `true` in
...
```clj
(ns cljapp.example
  (:require [cljapp.config :as config])
